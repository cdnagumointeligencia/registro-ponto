...
if (editId) {
    ...
    store.employees.push({ id, name, login_id:id, pass: await hashPassword(pass), nivel, setor:depts[0]||'', perfil, foto:fotoNovo, matricula, data_admissao: dataAdmissao, dept:depts[0]||'', role:perfil.funcao||'', filial:filiais[0]||'', turno:turnos[0]||'', supervisor_id:null, perf:0 });
